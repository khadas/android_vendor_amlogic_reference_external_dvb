...
dvbpsi_EXTENSION_dr_t * dvbpsi_DecodeEXTENSIONDr(dvbpsi_descriptor_t * p_descriptor)
{
  ...
  /* Allocate memory */
  p_decoded = (dvbpsi_EXTENSION_dr_t *)malloc(sizeof(dvbpsi_EXTENSION_dr_t));
  if (!p_decoded)
  {
  ...
  switch (p_decoded->i_extern_des_tag)
  {
    ...
    case AM_SI_EXTEN_DESCR_AUDIO_PRESELECTION:
      ...
      dvbpsi_Decode_Exten_Audio_Preselection_Dr(p_decoded, p_descriptor->p_data, p_descriptor->i_length);
      break;
